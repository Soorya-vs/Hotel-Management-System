...
public class Login extends JFrame implements ActionListener{
    ...
    Login(){
        ...
        cancel.setBounds(375, 220, 120, 30);
        ...
        image.setBounds(650, 50, 200, 200);
        add(image);
